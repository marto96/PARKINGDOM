...
--
-- Servidor: localhost
-- Tiempo de generación: 13-10-2018 a las 00:10:42
...
CREATE TABLE IF NOT EXISTS `tarifa` (
  ...
  `tarifa_automovil` double DEFAULT NULL,
  `tarifa_plena_moto` double NOT NULL,
  `tarifa_plena_automovil` int(11) NOT NULL,
...
INSERT INTO `tarifa` (`idtarifa`, `tarifa_moto`, `tarifa_automovil`, `tarifa_plena_moto`, `tarifa_plena_automovil`) VALUES
(1, 74, 105, 7000, 10000);
...
(5, 'Automovil', 'asd123', '2018-09-24 18:44:20', '2018-10-09 19:24:48', NULL, 1298428.000056),
